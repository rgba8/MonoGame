...
namespace Microsoft.Xna.Framework.Graphics
{
    public class SpriteBatch : GraphicsResource
    {
            ...
            float depth)
        {
            ...
            tmpV4.X = destinationRectangle.X;
            tmpV4.Y = destinationRectangle.Y;
            tmpV4.Z = destinationRectangle.Width;
            tmpV4.W = destinationRectangle.Height;

            tmpV2.X = origin.X * ((float)destinationRectangle.Width / (float)((sourceRectangle.HasValue && sourceRectangle.Value.Width != 0) ? sourceRectangle.Value.Width : texture.Width));
            tmpV2.Y = origin.Y * ((float)destinationRectangle.Height) / (float)((sourceRectangle.HasValue && sourceRectangle.Value.Height != 0) ? sourceRectangle.Value.Height : texture.Height);
